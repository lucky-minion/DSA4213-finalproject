...
class FLServer:
    ...
    def train_client(self, server_id):
        ...
        model_part2 = ModelPart2(num_classes=DatasetConfig.DATASET_NUM_CLASSES).to(self.device).eval()
        ...
        try:
            ...
            self.server_instances[server_id]['optimizer'] = torch.optim.AdamW(self.server_instances[server_id]['model'].parameters(), lr=5e-5)
